...
| **from anonymous public resources thru RESTful API / GraphQL API** <br> (outside the organization)| OAuth2.0 <br> (Must make the scheme on your own) | OAuth2.0 <br> (Cloud Service Providers provide you services below:) <br> - **Azure Service Principal** <br> - **AWS Cognito User/Identity Pools** |
