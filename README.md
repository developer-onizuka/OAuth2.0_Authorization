...
| --- | --- | --- | --- |
| #1 | GetSessionToken | IAM User's temporary security credentials | 1. There is already a long-term IAM user. <br>2. GetSessionToken Request with the AccessKey of the long-term IAM user. <br>3. Check if the long-term IAM user has a STS permission. <br>4. Provide IAM User's temporary security credentials. |
