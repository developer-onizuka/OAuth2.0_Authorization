...
| **from different cloud subscriptions** <br> (within the organization)| Connection String | - Connection String <br> - [Cross Account Access between AWS accounts](https://n2ws.com/blog/aws-cloud/managing-aws-accounts-cross-account-iam-roles) (but shoud be trusted between AWS accounts) <br> - [Azure Managed identities don't currently support cross-tenant scenarios.](https://learn.microsoft.com/en-us/azure/active-directory/managed-identities-azure-resources/managed-identities-faq#can-i-use-a-managed-identity-to-access-a-resource-in-a-different-directorytenant) But [you will access with Managed ID to any subscriptions which belongs to a Azure AD tenant](https://stackoverflow.com/questions/59069065/can-managed-identity-of-a-azure-function-have-access-across-multiple-subscriptio). See also [Azure AD External Identities](https://www.youtube.com/watch?v=3Pi_-pHIT_4) for B2B connection.|
