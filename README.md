...
| #2 | Connection String | - Easy to use. <br> - Define some limitation such as expiration date and IP Address. | - Likely to be leaked if it is used in the source code. | Safer than #1. You may use it for some trustworthy person or for temporary. |
