...
There are four types of grant in OAuth2.0, Authorization code, Implicit, Resource owner password credentials and Client credentials. But I take Client credentials as an example because it is used in Managed ID in Azure and easy for me to explain.
