...
One day, a lazy student in a dormitory uses a housekeeping service to have them wash his dirty clothes. The service guy does not have any permission to use washing machine in the dormitory. So he asks dormitory manager a token.<br>
But dormitory manager does not have any tokens in person, neither. So he asks it for the token manager who manages and maintains washing machines in the dormitory.<br>
