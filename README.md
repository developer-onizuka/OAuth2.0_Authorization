...
- In the Onprem enviornment, the ClientID would be managed by some reliable Database systems getting along with your App instead of Managed ID in cloud. <br>
